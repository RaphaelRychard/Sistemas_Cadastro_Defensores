...
try {
    ...
    $stmt = $conn->prepare(
        "INSERT INTO tabela_forms (nome, sobrenome, cpf, data_nascimento, rg, orgao_expedidor, uf, email, celular, sexo) VALUES (:nome, :sobrenome, :cpf, :dataNasc, :rg, :orgaoExpedidor, :uf, :email, :celular, :sexo)");
